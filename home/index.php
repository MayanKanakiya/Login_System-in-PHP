...
<head>
    <title>Welcome-Login Secure</title>
    <meta charset="utf-8">
...
// if you are login then only logout button show and reverse if you are logout then only login and signup button  show....
session_start();
...
echo ' <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                <li class="active1 "><a href="/pratice/login_system_php/home/index.php">Home</a></li>
...
<h2>Welcome User! This is Home page..</h2>
