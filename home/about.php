...
<head>
    <title>Welcome-About Page</title>
    <meta charset="utf-8">
...
<body>
    ...
    echo ' <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                <li><a href="/pratice/login_system_php/home/index.php">Home</a></li>
                <li class="active1"><a href="/pratice/login_system_php/home/about.php">About</a></li>
    ...
    if ($loggedin) {
        ...
        echo '<ul class="nav navbar-nav navbar-right">
                    <li><a href="/pratice/login_system_php//logout.php"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>
                </ul>';
    }
    echo '
            </ul>
